...
async def get_experiment(experiment_uuid: UUID, db: AsyncSession = Depends(get_db)):
...
async def update_experiment(
    experiment_uuid: UUID, experiment_update: ExperimentUpdate, db: AsyncSession = Depends(get_db)
):
...
async def delete_experiment(experiment_uuid: UUID, db: AsyncSession = Depends(get_db)):
...
async def get_experiment_columns(experiment_uuid: UUID, db: AsyncSession = Depends(get_db)):
